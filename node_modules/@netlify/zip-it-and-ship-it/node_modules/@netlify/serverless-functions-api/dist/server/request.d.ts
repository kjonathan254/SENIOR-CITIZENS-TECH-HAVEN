...
export declare const prepareRequestContext: ({ funcPath, url, headers, method, body, waitUntil, }: PrepareRequestOptions) => Promise<{
    req: NetlifyRequest;
    requestContext: RequestContext;
    cookies: CookieStore;
}>;
export declare const prepareRequest: (options: PrepareRequestOptions) => Promise<{
    req: NetlifyRequest;
    requestContext: RequestContext;
    cookies: CookieStore;
